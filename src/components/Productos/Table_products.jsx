...
export default function ProductsDemo() {
    ...
    const header = (
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            ...
            <IconField iconPosition="right">
                ...
                <InputText type="search" unstyled onInput={(e) => setGlobalFilter(e.target.value)} placeholder="Buscar..."className='' />
            </IconField>
        </div>
    );
    ...
    return (
        <div>
            ...
            <Dialog visible={productDialog} style={{ width: '50rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Crear producto" headerClassName='custom-header2' modal className="p-fluid custom-dialog"/*  footer={productDialogFooter} */ onHide={hideDialog}>
